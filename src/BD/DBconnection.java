...
public class DBconnection {
	/*private static final String URL = "jdbc:mysql://localhost:3306/sia";
	...
	private static final String URL = "jdbc:mysql://mysql-webert.alwaysdata.net/webert_airblio_project_";
